...
public class Predictions {
    ...
    // the predictions.Predictions array
	...
	// Convert the predictions.Predictions array into an XML document
	return toXML();
    }
	...
	// Read the data into the array of predictions.Predictions.
	if (in != null) {
	    try {
